...
<body>
  <form method="post" action="login">
    Username: <input type="text" name="amrit_paudel" required /><br/>
    Password: <input type="password" name="amrit@123#" required /><br/>
...
public class LoginServlet extends HttpServlet {
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    String user = request.getParameter("amrit_paudel");
    String pass = request.getParameter("amrit@123#");
